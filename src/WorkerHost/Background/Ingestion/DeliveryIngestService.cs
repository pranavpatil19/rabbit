...
/// <summary>
/// Pulls deliveries from the broker and pushes them into the shared delivery buffer.
/// </summary>
public sealed class DeliveryIngestService : PollingBackgroundService
{
    private readonly IMessageListener _messageListener;
    private readonly DeliveryQueue _deliveryQueue;
    private readonly ILogger<DeliveryIngestService> _logger;
    private IAsyncEnumerator<IInboundDelivery>? _inboundStream;

    public DeliveryIngestService(
        IMessageListener messageListener,
        DeliveryQueue deliveryQueue,
        ILogger<DeliveryIngestService> logger)
